...
export default function AccountPage() {
  ...
  const sessions = [
    ...
    { device: "Firefox on MacOS", location: "Bandung, Indonesia", lastActive: "Yesterday", current: false },
  ];
        ...
        <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="flex gap-2 mt-2">
                    <Badge className="bg-gradient-to-r from-purple-500 to-pink-500 shadow-md">{user.plan}</Badge>
            ...
            <CardContent className="pt-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {[
                  ...
                  { label: "Plan", value: user.plan, icon: "M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" },
                  { label: "Member Since", value: user.memberSince, icon: "M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" },
                  { label: "Last Login", value: user.lastLogin, icon: "M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" },
                ].map((item, i) => (
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="space-y-4 pt-6">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        {session.current && <Badge variant="success" size="sm" className="bg-green-100 text-green-700">Current</Badge>}
                      </div>
              ...
              <Button variant="outline" className="w-full mt-4 rounded-xl border-2 hover:border-red-500 hover:text-red-500">
