      ...
      <div className="rounded-xl border bg-gradient-to-r from-gray-50 to-gray-100 p-6">
        ...
        <div className="flex flex-wrap gap-3">
          <Button asChild variant="outline" className="hover:bg-white">
            <Link href="/api/export/csv" className="flex items-center gap-2">
          ...
          <Button asChild variant="outline" className="hover:bg-white">
            <Link href="/api/export/xlsx" className="flex items-center gap-2">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                <polyline points="14 2 14 8 20 8" />
              </svg>
          ...
          <Button asChild variant="outline" className="hover:bg-white">
            <Link href="/api/export/pdf" className="flex items-center gap-2">
              <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                <polyline points="14 2 14 8 20 8" />
              </svg>
