    ...
    <header className="sticky top-0 z-50 border-b border-border/60 bg-white/90 backdrop-blur-xl">
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <Button asChild size="sm" className="bg-gradient-to-r from-primary to-primary-light hover:from-primary-dark hover:to-primary shadow-sm hover:shadow-md">
...
export async function AppNav({ role }: { role: Role }) {
  ...
  const links = role === "ADMIN"
    ? [
        ...
        { label: "Account", href: "/dashboard/settings", icon: "M16 7a4 4 0 1 1-8 0 4 4 0 0 1 8 0zM12 14a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7z", color: "accent" },
    ...
    : [
        ...
        { label: "SUM Analysis", href: "/dashboard/sum-analysis", icon: "M7.5 14.25v2.25m3-4.5v4.5m3-6.75v6.75m3-9v9M6 20.25h12A2.25 2.25 0 0020.25 18V6A2.25 2.25 0 0018 3.75H6A2.25 2.25 0 003.75 6v12A2.25 2.25 0 006 20.25z", color: "warning" },
  ...
  return (
    <aside className="relative flex flex-col h-screen w-[280px] bg-gradient-to-b from-white via-white to-slate-50/50 border-r border-border/40">
      ...
      {/* Header */}
      <div className="relative flex h-20 items-center gap-3 px-6 border-b border-border/30">
        <LogoIcon />
